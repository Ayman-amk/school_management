        ...
        <div class="container p-md-4 p-sm-4">
            ...
            <div class="row mb-3 mt-md-5">
                <div class="col-md-3 mb-3">
                    <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#4561F5" Text="Add Fees" OnClick="btnAdd_Click" />
                </div> 
            </div>
            <div class="row mb-3">
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" AutoGenerateColumns="False"
                        EmptyDataText="No records to display!" AllowPaging="true" PageSize="4">
                        <Columns>
                            <asp:BoundField DataField="ClassId" HeaderText="Class ID" ReadOnly="True">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="FeesAmount" HeaderText="Fee Amount" ReadOnly="True">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                        </Columns>
